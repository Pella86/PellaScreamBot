...
import src.telegram.CallbackQueryDataManager as CbQueryManager
...
class PagesBase:
    ...
    def create_page_change_keyboard(self, keyboard, user_id):
        ...
        cb_data = CbQueryManager.CallbackQueryDataManager()
    ...
    def send_message(self, chat_id, user_id):
        ...
        if keyboard:
            self.bot.sendMessageKeyboard(chat_id, message_text, keyboard)  
        else:
    ...
    def change_page(self, cb_query):
        ...
        cb_manager = CbQueryManager.CallbackQueryDataManager()
